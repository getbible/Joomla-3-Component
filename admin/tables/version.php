...
class GetbibleTableVersion extends JTable
{
	public function __construct(&$db)
	{
		parent::__construct('#__getbible_versions', 'id', $db);
	}
	...
	public function check()
	{
		...
		// start logging...
		JLog::add('id->['.$this->id.'] name->['.$this->name.'] saved by ' . $user->name.'->['. $user->id.'] ip->['.$ip.']', JLog::NOTICE, 'Version');
